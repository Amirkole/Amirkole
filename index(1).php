...
🔥↤↤↤↤↤↤↤↤↦↦↦↦↦🔥
     "]);
                    ...
                    $MadelineProto->messages->editMessage(['peer' => $peer,'id' => $msg_id,'message' => "𝒀𝒐𝒖𝒓 𝑺𝒆𝒓𝒗𝒆𝒓 𝑷𝒊𝒏𝒈 ➢ $load[0]", 'parse_mode' => 'MarkDown']);
                     }
...
↫↫↫↫↫ ｍ𝐓ρ𝐫ｏ𝓽๏ ρяＯ𝔵Ⓨ 𝓕σг ｔＥㄥ𝓔𝓰я𝓪м ↬↬↬↬↬"]);
                    ...
                    if ($text == 'بمیر کرونا' or $text == 'Corona') {
                        ...
                        yield $this->messages->editMessage(['peer' => $peer, 'id' => $msg_id + 1, 'message' => '🇩🇪 کیرونارو شکست داد🇩🇪']);‌
                    }
